...
Article.create(title: "In other news!", content: "EU commission of lauries says Nikola has the best one ever.", category: "Other", user: editor_user)
Article.create(title: "In other other news!", content: "EU commission of lauries says Nikola has the best one ever.", category: "Other", user: editor_user)
Article.create(title: "While other news is delayed...", content: "EU commission of lauries says Nikola has the best one ever.", category: "Other", user: editor_user)
Article.create(title: "And yet... we have more news", content: "EU commission of lauries says Nikola has the best one ever.", category: "Other", user: editor_user)
