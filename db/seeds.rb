...
Article.create(title: "In other news!", content: "EU commission of lauries says Nikola has the best one ever.", category: "Products", user: editor_user)
Article.create(title: "In other other news!", content: "EU commission of lauries says Nikola has the best one ever.", category: "Products", user: editor_user)
Article.create(title: "While other news is delayed...", content: "EU commission of lauries says Nikola has the best one ever.", category: "Products", user: editor_user)
